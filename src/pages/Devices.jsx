      ...
      <DialogContent sx={{ background: colors.bgSecondary, pt: 2 }}>
        <Box sx={{ mb: 3 }}>
          ...
          <Typography variant="body2" sx={{ color: colors.textSecondary }}>
            Door ID: <strong style={{ color: colors.textPrimary }}>{device?.door_id}</strong>
          </Typography>
        </Box>
...
function DeviceRow({ device, onConfig, colors }) {
  ...
  return (
    <TableRow sx={{ '&:hover': { background: colors.bgHover } }}>
      ...
      <TableCell sx={{ color: colors.textPrimary, borderBottom: `1px solid ${colors.borderLight}` }}>{device.door_id || '-'}</TableCell>
      <TableCell sx={{ color: colors.textSecondary, borderBottom: `1px solid ${colors.borderLight}` }}>{device.hardware_type || '-'}</TableCell>
      <TableCell sx={{ color: colors.textSecondary, borderBottom: `1px solid ${colors.borderLight}` }}>{device.firmware_version || '-'}</TableCell>
      <TableCell sx={{ borderBottom: `1px solid ${colors.borderLight}` }}>
        <Chip
        ...
        {loading ? (
          ...
          <TableContainer>
            <Table size="small">
              <TableHead>
                <TableRow>
                  <TableCell sx={{ color: colors.textSecondary, borderBottom: `1px solid ${colors.border}` }}>Device ID</TableCell>
                  <TableCell sx={{ color: colors.textSecondary, borderBottom: `1px solid ${colors.border}` }}>Door ID</TableCell>
                  <TableCell sx={{ color: colors.textSecondary, borderBottom: `1px solid ${colors.border}` }}>Hardware</TableCell>
                  <TableCell sx={{ color: colors.textSecondary, borderBottom: `1px solid ${colors.border}` }}>Firmware</TableCell>
                  <TableCell sx={{ color: colors.textSecondary, borderBottom: `1px solid ${colors.border}` }}>Trạng thái</TableCell>
                  <TableCell sx={{ color: colors.textSecondary, borderBottom: `1px solid ${colors.border}` }}>Heartbeat</TableCell>
